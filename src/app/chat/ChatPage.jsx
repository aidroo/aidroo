...
import { deleteMessage, getContacts, getMessages, getProfile, sendMessage } from "./chat-config";
...
const ChatPage = () => {
  ...
  const [showContactSidebar, setShowContactSidebar] = useState(1);

  const [showInfo, setShowInfo] = useState(true);
  const queryClient = useQueryClient();
  // Memoize getMessages using useCallback
  const getMessagesCallback = useCallback((chatId) => getMessages(1), []);
  // reply state
