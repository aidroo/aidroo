"use client";
import f from "@/asserts/jsonfile/Jobs_Privacy_policy.json";
import { TabsContent } from "@/components/ui/tabs";
import Lottie from "lottie-react";
import { LuDot } from "react-icons/lu";
import { onlineJobsPrivacyPolicy } from "../_components/constants";
export default function JobsTermContent() {
  return (
    <TabsContent value="job-privacy-policy">
      <div className="border py-4 rounded-md  ">
        <div className="flex h-auto items-center justify-center bg-white px-6  ">
          <div className="space-y-6 ">
            ...
            {onlineJobsPrivacyPolicy.map((term, index) => (
